...
class AdvancedParkingSystem:
    def __init__(self, root):
        ...
        # Frame kamera
        self.camera_frame = ttk.LabelFrame(self.main_frame, 
                                         text=" Camera Preview ",
                                         padding=10)
        self.camera_frame.pack(fill=tk.BOTH, expand=False, pady=10)
        ...
        # ttk.Label(self.control_frame, text="Camera Source:").grid(row=0, column=0, padx=5)
        self.camera_entry = ttk.Entry(self.control_frame, width=30)
        self.camera_entry.grid(row=0, column=1, padx=5)
        self.camera_entry.insert(0, self.camera_ip)
        ...
        # self.run_app_btn.grid(row=0, column=3, padx=10)
    ...
    def connect_camera(self):
        self.camera_ip = self.camera_entry.get()
        self.status_var.set(f"Connecting to {self.camera_ip}...")
